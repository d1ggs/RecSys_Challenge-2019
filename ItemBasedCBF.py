...
class ItemBasedCBF:
    ...
    def fit(self, URM):
        ...
        self.SM_sub_class = self.compute_similarity_cbf(self.ICM_sub_class, top_k=self.topK_sub_class,
...
if __name__ == "__main__":
    ...
    parameters = [{"topK_asset": 100, "topK_price": 100, "topK_sub_class": 100, "shrink_asset": 2, "shrink_price": 2,
