...
class SearchAbstractClass(object):
    ...
    def _evaluate_on_validation(self, current_fit_parameters):
        ...
        result, result_string = self.evaluator_validation.evaluateRecommender(recommender_instance)

        evaluation_time = time.time() - start_time

        return {"MAP": result}, result_string, recommender_instance, train_time, evaluation_time
    ...
    def _evaluate_on_test(self, recommender_instance, current_fit_parameters_dict, print_log = True):
        ...
        # Evaluate recommender and get results for the first cutoff
        result, result_string = self.evaluator_test.evaluateRecommender(recommender_instance)
        ...
        return {"MAP": result}, result_string, evaluation_test_time
