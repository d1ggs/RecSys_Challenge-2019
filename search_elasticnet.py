...
if __name__ == '__main__':
    ...
    recommender_class = MultiThreadSLIM_ElasticNet
    ...
    hyperparameters_range_dictionary["l1_ratio"] = Real(0, 1)
    hyperparameters_range_dictionary["topK"] = Integer(0, 1000)
    hyperparameters_range_dictionary["positive_only"] = Categorical([True, False])
