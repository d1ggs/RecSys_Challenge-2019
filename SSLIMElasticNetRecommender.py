...
# Use these to disable the warnings
...
class SSLIMElasticNetRecommender(BaseItemSimilarityMatrixRecommender):
    ...
    def __init__(self, URM_train):
        ...
        super(SSLIMElasticNetRecommender, self).__init__(URM_train)

        self.ICM = sps.hstack([Helper().load_icm_asset(), Helper().load_icm_price(), Helper().load_icm_sub_class()])
...
class MultiThreadSSLIM_ElasticNet(SSLIMElasticNetRecommender, BaseItemSimilarityMatrixRecommender):

    def __init__(self, URM_train, mode=None):
        super(MultiThreadSSLIM_ElasticNet, self).__init__(URM_train)
...
if __name__ == '__main__':
    ...
    best = {'alpha': 0.0024081648139725204, 'l1_ratio': 0.0007553368138338653, 'positive_only': False, 'side_alpha': 3.86358712510434, 'topK': 65, 'random_state': 1234}
